...
import com.zhou.security.core.social.ZhouSpringSocialConfigurer;
...
public class SpringSocialConfigurerPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if(StringUtils.equals(beanName, "zhouSocialSecurityConfig")){
            ZhouSpringSocialConfigurer config = (ZhouSpringSocialConfigurer)bean;
